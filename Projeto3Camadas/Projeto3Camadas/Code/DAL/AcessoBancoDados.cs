...
namespace DAL //Namespace da camada de Banco de Dados. Pode ter qualquer nome, no entanto, por padrão chamamos de DAL - Data Access Layer
{
    class AcessoBancoDados
    {
        ...
        private String server = "192.168.25.7"; //Servidor, pode ser tanto a sua máquina local quanto um servidor de verdade
        ...
        private String database = "dbcliente"; //Banco de Dados
